  ...
  imports: [
   ...
   // App routes goes here
        ...
        children: [
          ...
          { path: 'centerofexcellence', component: CenterofexcellenceComponent },
          { path: 'edgepractice',  component: EdgepracticeComponent },
          { path: 'department',  component: DepartmentComponent },
          { path: 'designation', component: DesignationComponent },
          { path: 'bussinessgroup',  component: BussinessgroupComponent },
          { path: 'resourcereq',  component: ResourcerequestformComponent },
          { path: 'EmpProjInfo',  component: EmpProjManagementComponent },
          { path: 'EmpProjectInfo', component: EmpProjMngtInfoComponent },
          { path: 'panel',  component: PanelComponent },
          { path: 'vendor',  component: VendorComponent },
          { path: 'assign-panel', component: AssignPanelComponent },
          { path: 'applicant-profile-shortlist',  component: ApplicantProfileShortlistComponent },
          { path: 'assessment',  component: AssessmentComponent },
          { path: 'jobdescription',  component: JobdescriptionComponent },
          { path: 'applicant',  component: ApplicantComponent },
          { path: 'assessment/assesedit',  component: AssessmentEditPopupComponent },
          { path: 'skills',  component: ReportsSkillsetComponent },
          { path: 'EmpCat',  component: EmployeeCategoriesComponent },
          { path: 'deliverable',  component: DeliverableComponent },
          { path: 'powerBI-dashboard', component: PowerBiDashboardComponent },
           { path: 'timesheetstemplate',  component: TimesheetstemplateComponent }
                ]
        },
