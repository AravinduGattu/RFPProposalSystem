...
@Injectable()
export class RoleGuardRRF implements CanActivate {
  ...
  canActivate(): boolean {
    if (sessionStorage.getItem("mailId") && (sessionStorage.getItem("userType") == 'ADMIN' || sessionStorage.getItem("userType") == 'COE' || sessionStorage.getItem("userType") == 'DM'
      ...
      || sessionStorage.getItem("userType") == 'HR_ADMIN' || sessionStorage.getItem("userType") == 'PH' || sessionStorage.getItem("userType") == 'PM' || sessionStorage.getItem("userType") == 'RMG' || sessionStorage.getItem("userType") == 'TA_ADMIN')) {
