...
@Component({
    ...
    <input #textinput [attr.type]="params.inputtype" class='ag-cell-edit-input'
     [attr.maxlength]="params.maxlength" [attr.size]="params.maxlength" (keypress)="onKeyDown($event)" >
      </div>
    `,
    styles: [`
...
export class EditCellRenderNumberComponent implements ICellEditorAngularComp, AfterViewInit {
    public params: any;
