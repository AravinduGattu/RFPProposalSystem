...
@Component({
  selector: 'app-applicantprofilereview-editpopup',
  templateUrl: './applicantprofilereview-editpopup.component.html',
  styleUrls: ['./applicantprofilereview-editpopup.component.css']
})
export class ApplicantprofilereviewEditpopupComponent implements OnInit {
  ...
  title = 'EDIT PROFILE REVIEW'
  public applicantprofilereviewForm: FormGroup;

  constructor(@Inject(MAT_DIALOG_DATA) public data, public dialogRef: MatDialogRef<ApplicantprofilereviewEditpopupComponent>, public applicantProfileReviewService: ApplicantProfileReviewService, private notificationservice: NotificationService) { }
  ...
  Submit() {
    if (this.applicantProfileReviewService.applicantprofilereviewForm.valid) {
      this.applicantProfileReviews = Object.assign({}, this.applicantProfileReviewService.applicantprofilereviewForm.value);
      console.log(this.applicantProfileReviews);
      return this.applicantProfileReviewService.UpdateApplicantProfileReview(this.applicantProfileReviews).subscribe(
        result => {
          console.log(result);
